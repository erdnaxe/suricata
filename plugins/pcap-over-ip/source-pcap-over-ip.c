...
/**
 * \brief Registration Function for ReceivePcapOverIP.
 * \todo Unit tests are needed for this module.
 */
void TmModuleReceivePcapOverIPRegister(int slot)
{
    tmm_modules[slot].name = "ReceivePcapOverIP";
    tmm_modules[slot].ThreadInit = ReceivePcapOverIPThreadInit;
    tmm_modules[slot].Func = NULL;
    tmm_modules[slot].PktAcqLoop = ReceivePcapOverIPLoop;
    tmm_modules[slot].PktAcqBreakLoop = ReceivePcapOverIPBreakLoop;
    tmm_modules[slot].ThreadExitPrintStats = ReceivePcapOverIPThreadExitStats;
    tmm_modules[slot].ThreadDeinit = ReceivePcapOverIPThreadDeinit;
    tmm_modules[slot].cap_flags = SC_CAP_NET_RAW;
    tmm_modules[slot].flags = TM_FLAG_RECEIVE_TM;
}

/**
 * \brief Registration Function for DecodePcapOverIP.
 * \todo Unit tests are needed for this module.
 */
void TmModuleDecodePcapOverIPRegister(int slot)
{
    tmm_modules[slot].name = "DecodePcapOverIP";
    tmm_modules[slot].ThreadInit = DecodePcapOverIPThreadInit;
    tmm_modules[slot].Func = DecodePcapOverIP;
    tmm_modules[slot].ThreadExitPrintStats = NULL;
    tmm_modules[slot].ThreadDeinit = DecodePcapOverIPThreadDeinit;
